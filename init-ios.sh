...
IJK_FFMPEG_UPSTREAM=https://github.com/lirizhong97/FFmpeg.git
IJK_FFMPEG_FORK=https://github.com/lirizhong97/FFmpeg.git
IJK_FFMPEG_COMMIT=ff3.4--ijk0.8.7--20180103--001
IJK_FFMPEG_LOCAL_REPO=extra/ffmpeg

IJK_GASP_UPSTREAM=https://github.com/lirizhong97/gas-preprocessor.git

# gas-preprocessor backup
# https://github.com/lirizhong97/gas-preprocessor.git
...
function pull_fork() {
    ...
    git branch --set-upstream-to=origin/ijkplayer ijkplayer
    git pull
    cd -
}
